...
// const unisWithUni = graduates[graduates.];
const unisWithUni = [];
...
const zooAnimals = [
  ...
  { animal_name: "White sp oonbill", population: 8, scientific_name: "Platalea leucordia", state: "Georgia" },
...
//   lowCaseAnimalNames.push(animal_name.toLowerCase())
// });
...
const lowPop = zooAnimals.filter(animal => animal.population < 5);;
console.log(lowPop);
...
const populationTotal = zooAnimals.reduce (function cb(items, pop){
  return items + pop.population
},0)
